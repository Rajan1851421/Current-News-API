...
export class Technology extends Component {
   ...
   static propTypes = {
    ...
    async componentDidMount(){
        let url=`https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=9b7571cb6cc94c6a897fda39db74b3bc&page=1&pageSize=${this.props.pageSize}`;
    ...
    handleNextClick =async()=>{
        ...
        let url=`https://newsapi.org/v2/top-headlines?country=in&category=${this.props.category}&apiKey=9b7571cb6cc94c6a897fda39db74b3bc&page=${this.state.page+1}&pageSize=${this.props.pageSize}`;
        this.setState({loading: true});
        let data= await fetch(url);
        let parsData= await data.json();
        ...
        <>
          <div className='container my-3'>
            ...
            <br />
                 ...
                 <h1 className='my-2 bold text-center '> Top Headlines Realated Technology</h1>
